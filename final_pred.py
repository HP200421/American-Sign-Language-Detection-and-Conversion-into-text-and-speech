...
class Application:
    ...
    def __init__(self):
        ...
        self.root = tk.Tk()
        self.root.title("FingerScripter: Converting Fingerspelling to Text and Speech")
        ...
        self.T.config(text="FingerScripter: Converting Fingerspelling to Text and Speech", font=("Times New Roman", 30, "bold"))
